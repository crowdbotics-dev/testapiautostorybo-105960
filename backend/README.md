...
## Project Structure
    ...
    ├── testapiautostorybo_105960  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_105960`
...
2. Clone this repo and `cd testapiautostorybo_105960`
